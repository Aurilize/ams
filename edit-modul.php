                    ...
                    <div class="card">
                        <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="project-modul" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" name="project" class="form-control" value="AFCA">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" name="project" class="form-control" value="2018">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                    <select data-placeholder="Select Lead" class="selectlead form-control" multiple="multiple">
                                                      ...
                                                      <option value="MK" selected>Marwalton Kemit</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                    <select data-placeholder="Select member(s)" class="selectteam form-control" multiple="multiple">
                                                      ...
                                                      <option value="AY" selected>Agustina A Y S</option>
                                                      <option value="EY">Elfana Y P</option>
                                                      <option value="AR">Adam Razadin</option>
                                                      <option value="AD">Agnes Dyna S</option>
                                                      <option value="AP">Aprilia Nur A</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="datepic col-lg-2">
                                                <input type="text" class="form-control" value="30-09-2018"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" name="reason" class="form-control" id="val-username" name="val-username" value="-">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" name="pica" class="form-control" id="val-username" name="val-username" value="-">
                                            </div>
                                        </div>
