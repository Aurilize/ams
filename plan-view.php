                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="add_audituniverse" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="site" name="val-skill" disabled>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="activity" name="val-skill" disabled>
                                                    <option value="">Please select</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="sub" name="val-skill" disabled>
                                                    <option value=""> Please select</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1">
                                                <input type="text" name="mgmt" class="form-control" value="3" disabled>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1">
                                                <input type="text" name="mgmt" class="form-control" value="2" disabled>
                                            </div>
                                            ...
                                            <div class="col-lg-1">
                                                <input type="text" name="mgmt" class="form-control" value="1" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-1">
                                                <input type="text" name="mgmt" class="form-control" value="4" disabled>
                                            </div>
                                        </div>
