                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="people" method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="val-username" data-toggle="tooltip" title="Input Nama Auditor" value="Aprilia">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">NIK <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="val-email" data-toggle="tooltip" title="Input NIK auditor" value="10020972">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-password">Tempat Lahir <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-password" name="val-password" data-toggle="tooltip" title="Input Tempat Lahir Auditor" value="Kebumen">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-confirm-password">Tanggal Lahir <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" placeholder="dd/mm/yyyy" value="2017-06-01">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-suggestions">Alamat <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <textarea class="form-control" id="val-suggestions" name="val-suggestions" rows="5" data-toggle="tooltip" title="Input Alamat auditor">The Honey Lady Lt. 10</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-number" name="val-number" data-toggle="tooltip" title="Input No. HP Auditor" value="081301019999">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-phoneus">Tanggal Hire <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="date" id="datehire" class="form-control" placeholder="dd/mm/yyyy" value="2017-06-01">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-digits">Tanggal End <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="date" id="enddate" class="form-control" placeholder="dd/mm/yyyy" value="2099-12-31">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="val-email" data-toggle="tooltip" title="Input auditor's competency" value="IT Auditing; PHP; MySQL; javascript;">
                                            </div>
                                        </div>
                                        <div class="form-group row">
            ...
            <div>
                <div class="container">
                    ...
                    <tbody>
                        <tr>
                            <td width="30%">
                                <input type="text" name="training" class="form-control" value="IDEA Analytics Tool" />
                            </td>
                            <td width="20%">
                                <input type="text" name="by"  class="form-control" value="Insight Consulting" />
                            </td>
                            <td width="25%">
                                <input type="text" name="location"  class="form-control" value="Jakarta" />
                            </td>
                            <td width="15%">
                                <input type="text" name="year" class="form-control" value="2018" />
                            </td>
