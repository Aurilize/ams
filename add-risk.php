                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="risk-assessment" method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="val-username" data-toggle="tooltip" value="PT. Bukit Makmur Mandiri Utama" disabled="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-risk" name="val-username" data-toggle="tooltip" title="Input Risk">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-risk" name="val-username" data-toggle="tooltip" title="Input Control" value="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
