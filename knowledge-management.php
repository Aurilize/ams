    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">Knowledge Management</h3></div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Knowledge Management</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <a href="add-knowlegde"><button type="submit" class="btn btn-info">Add Knowledge</button></a>                          
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit-knowlegde"><button type="submit" class="btn btn-warning btn-xs">Edit</button></a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Remove Knowledge File</h5>
