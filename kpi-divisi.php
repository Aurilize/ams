...
<div id="main-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">KPI Divisi</li>
                </ol>
            </div>
        </div>
        <!-- End Bread crumb -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                                <h4 class="card-title">KPI Divisi</h4>
                                    <a href="add-kpi-divisi"><button type="submit" class="btn btn-info">Add KPI Divisi</button></a>
    ...
    <div class="modal fade" id="viewIPPA" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">List KPI Divisi</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body modal-lg">
            <div>
                <div class="">
                    ...
                    <tbody>
                        <tr>
                            <th colspan="9" align="left">Financial</b></th>
                        </tr>
                        <tr>
                            <td>1</td>
                            <td>2018</td>
                            ...
                            <td>-</td>
                            <td>
                                <a href="edit-kpidiv"><button type="submit" class="btn btn-success btn-xs" data-toggle="modal" data-target="#editKPI">Edit</button></a>
                                <button type="submit" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#removePeople">Remove</button>
                            </td>
                        </tr>
                        <tr>
                            <th colspan="9" align="left">Customer</b></th>
                        </tr>
                        <tr>
                            <td>1</td>
                            <td>2018</td>
                            <td>Audit Customer Survey</td>
                            <td>Index</td>
                            <td>5%</td>
                            <td>3</td>
                            <td>4</td>
                        ...
                        <tr>
                            <td>2</td>
                            <td>2018</td>
                            <td>% Reccomendation Implement</td>
                            <td>Prosentase</td>
                            <td>10%</td>
                            <td>90%</td>
                            <td>85%</td>
                        ...
                        <tr>
                            <th colspan="9" align="left">Internal Business Process</b></th>
                        </tr>
                        <tr>
                            <td>1</td>
                            <td>2018</td>
                            <td>%COE Compliance</td>
                            <td>%</td>
                            <td>10%</td>
                            <td>80%</td>
                            <td>85%</td>
