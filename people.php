                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Active</td>
                                                <td>
                                                    <a href="view-people"><button type="submit" class="btn btn-success btn-xs" data-toggle="modal" data-target="#viewPeople">View</button>
                                                    <a href="edit-people"><button type="submit" class="btn btn-warning btn-xs">Edit</button></a>
